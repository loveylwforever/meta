package com.loveylwforever.meta.auth.support.core;
 ...
 * @date 2022-06-04
 */
public class MetaDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	public MetaDaoAuthenticationProvider() {
